...
namespace DAL.Migrations
{
    ...
    [Migration("20210413220908_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASPNetCore.Model.Category", b =>
                {
            ...
            modelBuilder.Entity("ASPNetCore.Model.Delivery", b =>
                {
            ...
            modelBuilder.Entity("ASPNetCore.Model.DeliveryLine", b =>
                {
            ...
            modelBuilder.Entity("ASPNetCore.Model.Order", b =>
                {
            ...
            modelBuilder.Entity("ASPNetCore.Model.OrderLine", b =>
                {
            ...
            modelBuilder.Entity("ASPNetCore.Model.Product", b =>
                {
            ...
            modelBuilder.Entity("ASPNetCore.Model.DeliveryLine", b =>
                {
                    b.HasOne("ASPNetCore.Model.Delivery", "IdDeliveryFkNavigation")
                        .WithMany("DeliveryLine")
                        .HasForeignKey("IdDeliveryFk")
                        .HasConstraintName("FK_Delivery_line_Delivery");

                    b.HasOne("ASPNetCore.Model.Product", "IdProductFkNavigation")
                        .WithMany("DeliveryLine")
            ...
            modelBuilder.Entity("ASPNetCore.Model.OrderLine", b =>
                {
                    b.HasOne("ASPNetCore.Model.Order", "IdOrderFkNavigation")
                        .WithMany("OrderLine")
            ...
            modelBuilder.Entity("ASPNetCore.Model.Product", b =>
                {
                    b.HasOne("ASPNetCore.Model.Category", "IdCategoryFkNavigation")
                        .WithMany("Product")
